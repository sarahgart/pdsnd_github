...
I wanted to investigate the differences and similarities in the rental time of the bikes in the three cities within 24 hours of users picking up the bike; i.e. how long does it take people to bring the bike back to a station after having rented it? To answer this question, I calculated the mean and median value for all rental times (trip duration) 24 hours and less for each city and plotted the corresponding distribution curve.
...
plot2 <- ggplot(df_bikeshare_user, aes(x = df_bikeshare_user$trip_duration/60,  col = user_type)) +
  ...
  xlab("Trip Rental Time (hours)") +
  ylab("Frequency of Bike Rentals") +
